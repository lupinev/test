...
$this->fontdata = array(
	/* NOTE Edited By GMT, Added Aial Rounded Font */
	"warial" => array(
		'R' => "WArial-Regular.ttf",
		'B' => "WArial-Bold.ttf",
		'I' => "WArial-Italic.ttf",
		'BI' => "WArial-Regular.ttf",
		),
	"warialrounded" => array(
		'R' => "WArialRounded-Bold.ttf",
		'B' => "WArialRounded-Bold.ttf",
		'I' => "WArialRounded-Bold.ttf",
		'BI' => "WArialRounded-Bold.ttf",
		),
	"warialblack" => array(
		'R' => "WArialBlack-Regular.ttf",
		'B' => "WArialBlack-Regular.ttf",
		'I' => "WArialBlack-Regular.ttf",
		'BI' => "WArialBlack-Regular.ttf",
		),
	"wtimes" => array(
		'R' => "WTimesRX.ttf",
		'B' => "WTimesB.ttf",
